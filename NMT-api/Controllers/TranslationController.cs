    ...
    ISrtTranslationService srtTranslationService) : ControllerBase
{
    ...
    [Produces("text/plain")]
    public async Task<IActionResult> TranslateFile(
        [FromForm] IFormFile file,
        [FromForm] string sourceLanguage = "fr",
        [FromForm] string targetLanguage = "en",
        [FromForm] int maxNewTokens = 256,
        [FromForm] int numBeams = 4,
        [FromForm] bool preprocess = true)
    {
        ...
        (string normalized, _) = preprocess ? TextPreprocessor.Normalize(input) : (input, []);
    ...
    [Consumes("multipart/form-data")]
    public async Task<ActionResult<TranslateResponse>> TranslateFileJson(
        [FromForm] IFormFile file,
        [FromForm] string sourceLanguage = "fr",
        [FromForm] string targetLanguage = "en",
        [FromForm] int maxNewTokens = 256,
        ...
        [FromForm] bool preprocess = true)
    {
        ...
        (string normalized, List<string> appliedRules) = preprocess
        ...
        return Ok(new TranslateResponse
        {
            ...
            Device = translation.Device,
            DurationMs = translation.DurationMs,
            Preprocessing = preprocess ? appliedRules : null
        });
    }
    ...
    [Consumes("multipart/form-data")]
    [Produces("text/plain")]
    public async Task<IActionResult> TranslateSrt(
        [FromForm] IFormFile file,
        [FromForm] string sourceLanguage = "fr",
        [FromForm] string targetLanguage = "en",
        [FromForm] int maxNewTokens = 256,
